    ...
    <div class="container-fluid">
        ...
        <div style="height: 0; margin-top: 350px" class="row">
            <div style="padding-top: 10px; padding-bottom: 10px;" class="col-12">
                <button style="height: 80px; width: 10em; margin-left: 100px" type="button" class="btn btn-primary">GET
                    THE
                    APP
                </button>
            </div>
...
<div style=" background-color: black; padding-top: 100px" class="container-fluid">
    <div class="row">
        <div class="col-lg-4 offset-lg-1">
            <p style="color: white; margin-top: 100px">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum pretium
